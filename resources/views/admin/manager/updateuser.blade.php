...
<article class="page-container">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9 skin-minimal">
			<div class="radio-box">
				<input name="mg_sex" type="radio" id="sex-1" value="男" <?php echo $manager->mg_sex =='男'?"checked='checked'":""; ?>>
				<label for="sex-1">男</label>
			</div>
			<div class="radio-box">
				<input type="radio" id="sex-2" name="mg_sex" value="女" <?php echo $manager->mg_sex =='女'?"checked='ehecked'":""?>>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" placeholder="@" name="mg_email" id="mg_email"  value="<?php echo $manager->mg_email?>">
		</div>
	</div>
	<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="mg_remark" id="mg_remark" style="width:546px;height:110px;" class="textarea"><?php echo $manager->mg_remark?></textarea>
...
$(function(){
    ...
    $('#form-admin-add').submit(function(evt){
        ...
        //执行ajax
        $.ajax({
            url:'/admin/manager/updateuser/<?php echo $manager->mg_id;?>',
            data:shuju,
            dataType:'json',
            type:'post',
